...
echo =======================================================
echo   [0/6] Checking Prerequisites (WSL and Docker)
echo =======================================================
...
if errorlevel 1 (
    ...
    echo Restart your computer afterward, then run this script again.
    pause
    exit /b 1
)
...
if errorlevel 1 (
    ...
    echo Please install Docker Desktop for Windows before running this script.
    pause
    exit /b 1
)

:: Check if Docker Daemon is running, start it if it is closed
