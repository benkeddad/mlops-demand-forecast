...
call docker build -t rossmann-api:latest -f docker\api.Dockerfile .
if errorlevel 1 (
...
call docker build -t rossmann-mlflow:latest -f docker\mlflow.Dockerfile .
if errorlevel 1 (
...
call docker build -t rossmann-prefect:latest -f docker\prefect.Dockerfile .
if errorlevel 1 (
